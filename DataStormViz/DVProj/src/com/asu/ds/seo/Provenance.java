...
@WebServlet({"/provenance", "/provenance/", "/provenance/*"})
public class Provenance extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if (flag) {
			Seo.forward(Seo.getSeoPath(Seo.PROVENANCE, Seo.TYPE_JSP), request, response);
		} else {
			String target_url = Seo.getSeoPath(Seo.PROVENANCE, Seo.TYPE_FULL);
